...
When the a new buisness rule is enforced, the Resource driven client is not able to tolerate those changes, while the Hypermedia 
...
This is not designed to be a complete example on how to implement a hypermedia client! It is trivalised significantly.
It does not describe how to implement a custom media type, nor does it describe the implementation of hypermedia affordences such
as forms. This is a contrived example designed to illustrate a basic evolvavlity as a property of hypermedia.
